...
from backend.api import auth, clubs, collabs, players, printers, stores, orders, inbound, cutting, outbound, search, inventory, history, reports
...
for router_module in [auth, clubs, collabs, players, printers, stores, orders, inbound, cutting, outbound, search, inventory, history, reports]:
