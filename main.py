...
from backend.api import auth, clubs, collabs, players, printers, orders, inbound, cutting, outbound, search
...
for router_module in [auth, clubs, collabs, players, printers, orders, inbound, cutting, outbound, search]:
